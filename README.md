# @anas-setti/n8n-nodes-x402-api

[![npm version](https://img.shields.io/npm/v/@anas-setti%2Fn8n-nodes-x402-api.svg)](https://www.npmjs.com/package/@anas-setti/n8n-nodes-x402-api)
...
2. Enter `@anas-setti/n8n-nodes-x402-api` as the package name
3. Click **Install**

### Via npm

```bash
npm install @anas-setti/n8n-nodes-x402-api
```
